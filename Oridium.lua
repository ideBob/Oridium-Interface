...
local CombatSection = Tabs.Combat:AddLeftGroupbox("Combat")
local TriggerSection = Tabs.Combat:AddRightGroupbox("Triggerbot")
local ESPSection = Tabs.Visuals:AddLeftGroupbox("ESP")
local AimviewerSection = Tabs.Visuals:AddRightGroupbox("Aimviewer")
local MovementSection = Tabs.Player:AddLeftGroupbox("Movement")
local AntiSection = Tabs.Player:AddRightGroupbox("Anti Detection")
...
-- ==================== ANTI DETECTION ====================
AntiSection:AddToggle("AntiDetection", {
    Text = "Anti Detection",
    Default = false,
    Callback = function(v)
...
CombatSection:AddSlider("AimbotRange", {
    Text = "Aimbot Range",
    Default = 1000,
    Min = 50,
    Max = 3000,
...
TriggerSection:AddToggle("Triggerbot", {
    Text = "Triggerbot",
    Default = false,
    Tooltip = "Revolver / Double-Barrel SG",
    Callback = function(v)
        State.Triggerbot = v
...
TriggerSection:AddSlider("TriggerFOV", {
    Text = "Trigger FOV",
    Default = 70,
    Min = 20,
    Max = 150,
...
TriggerSection:AddSlider("TriggerCooldown", {
    Text = "Cooldown",
    Default = 0.28,
    Min = 0.1,
    Max = 1,
...
ESPSection:AddToggle("ESPPreview", {
    Text = "ESP Preview",
    Default = false,
    Callback = function(v)
        State.ESPPreview = v
...
ESPSection:AddToggle("OridiumLines", {
    Text = "Oridium Lines",
    Default = false,
    Callback = function(v)
        State.OridiumLines = v
        if not v then for _, l in pairs(OridiumLines) do l.Visible = false end end
    end
})
...
AimviewerSection:AddToggle("Aimviewer", {
    Text = "Aimviewer",
    Default = false,
    Callback = function(v)
        State.Aimviewer = v
        if not v then for _, l in pairs(AimviewerCache) do l.Visible = false end end
    end
})
...
ThemeManager:SetFolder("OridiumLOL")
SaveManager:SetFolder("OridiumLOL/configs")
SaveManager:BuildConfigSection(Tabs.Settings)
ThemeManager:ApplyToTab(Tabs.Settings)
SaveManager:LoadAutoloadConfig()

-- RGB Accent toggle
AntiSection:AddToggle("RGBMode", {
    Text = "RGB Accent",
    Default = false,
    Callback = function(v)
        State.RGB = v
